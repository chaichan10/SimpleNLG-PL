 ...
 * {@link polishnlg.lexicon.Lexicon}, and usually the developer retrieves a
 * WordElement via a lookup method in the lexicon
 *
 * Words always have a base form, and usually have a
 * {@link polishnlg.framework.LexicalCategory}. They may also have a Lexicon ID.
 */
...
public class WordElement extends NLGElement {
	...
	public void setGender(String value) {
		...
		switch(value) {
			case "MP":
				this.setFeature(LexicalFeature.GENDER, Gender.MASC_PERSON);
				break;
			case "F":
			...
			case "N":
				...
				break;
			case "MZ":
				this.setFeature(LexicalFeature.GENDER, Gender.MASC_ANIMAL);
				break;
			case "MO":
				this.setFeature(LexicalFeature.GENDER, Gender.MASC_OBJECT);
				break;
			default:
				break;
		}
