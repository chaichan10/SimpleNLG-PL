...
public abstract class NLGElement {
    ...
    public void setComparative(boolean isComp) {
        if (isComp) {
            setFeature(Feature.IS_COMPARATIVE, true);
        } else {
            setFeature(Feature.IS_COMPARATIVE, false);
        }
    }
    
    public void setSuperlative(boolean isSup) {
        if (isSup) {
            setFeature(Feature.IS_SUPERLATIVE, true);
        } else {
            setFeature(Feature.IS_SUPERLATIVE, false);
        }
    }
