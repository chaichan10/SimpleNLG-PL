...
public enum DiscourseFunction {
    ...
    /**
     * Locative case for nouns indicating that a noun is being talked about as the location of something or similar concepts, such as being talked about
     * Does not include being the destination of something
     * ex. 'myślę o domu', 'jestem w szkole'
     */
    LOCATIVE,
    
    /**
     * Instrumental case for nouns that are the non-object instrument of some action, i.e. tool used to do something on something, person being walked together with, etc.
     * ex. 'chodze z psem', 'wbijam gwóźdź młotkiem'
     */
    INSTRUMENTAL,
    
    /**
     * 'Case' for nouns that puts them in an exclamatory form
     * ex. 'Jasiu, jak się masz?'
     */
    VOCATIVE;
}
